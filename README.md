...
The system provides functionality for managing employees, teams, roles, privileges, and employee leave requests. Access to different operations is 
controlled through role-based permissions, allowing users to perform actions according to their responsibilities.
...
### Project Structure
The application follows a layered architecture with separate components for configuration, controllers, DTOs,
exception handling, mapping, models, repositories, services, utilities, and validation.
